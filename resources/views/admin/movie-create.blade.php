      ...
      <form enctype="multipart/form-data" method="POST" action="{{route('admin.movie.store')}}">
        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" name="title" placeholder="e.g Fuad Ganteng" value="{{ old('title') }}">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="movie" name="movie" value="{{ old('') }}" placeholder="Video url">
          </div>
          <div class="form-group">

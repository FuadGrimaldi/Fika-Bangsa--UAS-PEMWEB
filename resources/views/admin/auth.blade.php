...
<div class="login-box">
  <div class="login-logo">
    <a href="{{ route('admin.login') }}" class="">
      <img src="{{ asset('stream/assets/images/fika.png') }}" width="200px" height="150px" alt="fika">
    </a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    ...
    @endif
      ...
      <form action="{{ route('admin.login.auth')}}" method="post">
        ...
        <div class="input-group mb-3">
          ...
          <div class="input-group-append">
            <div class="input-group-text">
              <i class="fa-solid fa-eye-slash" onclick="showPasswd()"></i>
            </div>
          </div>
        </div>
        <div class="row">

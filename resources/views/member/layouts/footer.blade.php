...
<!-- Footer container -->
<footer
    class="bg-black text-center text-neutral-600  dark:text-neutral-200 lg:text-left text-xs">
    <div
        ...
        <a href="https://www.facebook.com/itenas.official?mibextid=LQQJ4d" class="mr-6 text-neutral-600 dark:text-neutral-200">
            <svg
        ...
        <a href="https://www.itenas.ac.id/" class="mr-6 text-neutral-600 dark:text-neutral-200">
            <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
            fill="currentColor"
    ...
    <div class="mx-6 py-4 text-center md:text-left">
        ...
        <div>
            <h6
            class="mb-4 flex justify-center font-semibold uppercase md:justify-end">
            Contact
            </h6>
            <p class="mb-2 flex items-center justify-center md:justify-end">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"

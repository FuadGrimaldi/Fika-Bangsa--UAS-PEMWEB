...
@section('content')
                ...
                <div class="block lg:hidden bg-[#28130a] pb-3">
                    <div class="font-semibold text-[22px] text-white py-3 px-3">Trending Now</div>
                    ...
                    <div class="grid grid-cols-2 gap-5 xl:gap-12">
                        <div class="col-span-1 relative overflow-hidden group">
                            <img src="{{ asset('storage/thumbnail/'.$movie->small_thumbnail) }}" class="object-cover rounded-[10px] ml-3 h-[180px] w-[130px]" alt="">
                ...
                <!-- Movie -->
                <div>
                    <div class="font-semibold text-[22px] text-white lg:py-0 py-3 lg:mb-[40px] lg:ml-0 ml-3">Movie</div>
